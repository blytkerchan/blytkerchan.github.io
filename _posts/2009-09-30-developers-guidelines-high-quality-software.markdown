...
![247-pie](http://rlc.vlinder.ca/wp-content/uploads/2009/09/247-pie.png)while a small majority has standards in place, an appalling number of businesses and developer teams still don't - and some don't know, which means that if there are any, they are not being followed. Let's take another quote (from the same parahraph):
